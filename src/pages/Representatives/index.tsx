...
const Representatives = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Paw {t("menu.representatives")}</title>
      </Helmet>
      <Row gutter={[12, 0]}>
        <Col xs={24} md={12}>
          <PieChart
          ...
          >
            ...
            <Row gutter={6}>
              ...
              <Col xs={24} sm={16}>
                {" "}
                <Skeleton {...confirmationQuorumSkeletonProps}>
                  {new BigNumber(rawToRai(onlineWeightMinimum)).toFormat()} PAW
                </Skeleton>
              </Col>
            </Row>
            <Row gutter={6}>
              ...
              <Col xs={24} sm={16}>
                <Skeleton {...confirmationQuorumSkeletonProps}>
                  {new BigNumber(rawToRai(onlineStakeTotal)).toFormat(0)} PAW
                </Skeleton>
              </Col>
            </Row>
            <Row gutter={6}>
              ...
              <Col xs={24} sm={16}>
                <Skeleton {...confirmationQuorumSkeletonProps}>
                  {new BigNumber(rawToRai(peersStakeTotal)).toFormat(0)} PAW
                </Skeleton>
              </Col>
            </Row>
          </Card>
